<template>
  <svg width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
    <path d="M3 21L12 21H21" stroke="white" stroke-linecap="round" stroke-linejoin="round" />
